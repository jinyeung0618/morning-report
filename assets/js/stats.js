...
(function () {
  ...
  const STOCKS = {
    ...
    '005930': {
      label: '005930 · 삼성전자',
      iconSlug: 'samsung', iconColor: '1428a0',
      nameKo: '삼성전자',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2010-01', 16000], ['2015-01', 25000], ['2017-11', 56000],
        ['2018-12', 38000], ['2020-03', 42000], ['2021-01', 91000],
        ['2022-09', 51000], ['2024-07', 88000], ['2024-12', 53000],
        ['2026-05', 75000],
      ],
      events: [
        { date: '2017-11', title: '반도체 슈퍼사이클 1차 정점' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2021-01', title: '동학개미 + 메모리 정점 ATH ₩91k' },
        { date: '2022-09', title: '메모리 다운사이클 저점' },
        { date: '2024-07', title: 'HBM 후발주자 우려 vs 가전 회복' },
        { date: '2024-12', title: 'HBM·파업·실적 동시 부담 저점' },
      ],
    },
    ...
    '005935': {
      ...
      currency: '₩',
      refs: [
        ['2010-01', 12000], ['2015-01', 20000], ['2017-11', 45000],
        ['2020-03', 35000], ['2021-01', 84000], ['2022-09', 45000],
        ['2024-07', 73000], ['2024-12', 44000], ['2026-05', 63000],
      ],
      events: [
        { date: '2017-11', title: '반도체 사이클 정점' },
        { date: '2021-01', title: '우선주 ATH 권역 (보통주 따라)' },
        { date: '2024-12', title: '저점' },
      ],
    },

    '000660': {
      label: '000660 · SK하이닉스',
      badge: { cls: 'sk', text: 'SK' },
      nameKo: 'SK하이닉스',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2010-01', 25000], ['2015-04', 50000], ['2018-05', 90000],
        ['2019-01', 60000], ['2020-03', 70000], ['2021-03', 145000],
        ['2022-09', 80000], ['2023-04', 80000], ['2024-03', 180000],
        ['2024-08', 260000], ['2025-01', 200000], ['2026-05', 230000],
      ],
      events: [
        { date: '2018-05', title: '메모리 슈퍼사이클 1차 정점' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2021-03', title: '메모리 정점 ₩145k' },
        { date: '2022-09', title: '메모리 다운 저점' },
        { date: '2024-03', title: 'HBM 폭등 시작 — NVIDIA 공급' },
        { date: '2024-08', title: 'HBM 정점 ₩260k' },
      ],
    },
    ...
    '402340': {
      ...
      currency: '₩',
      refs: [
        ['2021-11', 60000], ['2022-10', 35000], ['2023-04', 38000],
        ['2024-04', 75000], ['2024-08', 110000], ['2025-01', 90000],
        ['2026-05', 105000],
      ],
      events: [
        { date: '2021-11', title: 'SK텔레콤에서 분할 상장' },
        { date: '2022-10', title: '단기 저점' },
        { date: '2024-08', title: 'SK하이닉스 폭등 동조 정점' },
      ],
    },

    '298040': {
      label: '298040 · 효성중공업',
      badge: { cls: 'hyosung', text: '효성' },
      nameKo: '효성중공업',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2018-06', 50000], ['2020-03', 35000], ['2022-09', 60000],
        ['2024-03', 200000], ['2024-09', 450000], ['2025-04', 600000],
        ['2026-05', 550000],
      ],
      events: [
        { date: '2018-06', title: '효성 분할 상장' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2024-03', title: 'AI 데이터센터 변압기 슈퍼사이클 시작' },
        { date: '2024-09', title: 'HVDC 수출 본격화' },
        { date: '2025-04', title: '사상 최고 ₩600k' },
      ],
    },

    // 국내 ETF
    '069500': {
      label: '069500 · KODEX 200',
      badge: { cls: 'kodex', text: 'KODEX' },
      nameKo: '코스피200',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2002-09', 8000], ['2008-10', 14000], ['2010-01', 23000],
        ['2015-04', 26000], ['2018-01', 33000], ['2020-03', 22000],
        ['2021-06', 45000], ['2022-09', 30000], ['2024-07', 39000],
        ['2024-12', 33000], ['2026-05', 38000],
      ],
      events: [
        { date: '2008-10', title: '글로벌 금융위기 저점' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2021-06', title: '동학개미 정점' },
        { date: '2024-12', title: '계엄 + 정치 변수 저점' },
      ],
    },

    '278530': {
      label: '278530 · KODEX 200TR',
      badge: { cls: 'kodex', text: 'KODEX' },
      nameKo: '코스피200 TR (배당재투자)',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2017-11', 9000], ['2018-10', 8200], ['2020-03', 7500],
        ['2021-06', 16000], ['2022-09', 10500], ['2024-07', 14500],
        ['2024-12', 12200], ['2026-05', 14800],
      ],
      events: [
        { date: '2017-11', title: 'KODEX 200TR 상장' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2021-06', title: '동학개미 정점' },
      ],
    },
    ...
    '396500': {
      label: '396500 · TIGER 반도체TOP10',
      badge: { cls: 'tiger', text: 'TIGER' },
      nameKo: 'TIGER Fn반도체TOP10',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2021-08', 10000], ['2022-10', 6500], ['2023-04', 8000],
        ['2024-03', 18000], ['2024-08', 16000], ['2024-12', 13000],
        ['2026-05', 17000],
      ],
      events: [
        { date: '2021-08', title: 'TIGER 반도체TOP10 상장' },
        { date: '2022-10', title: '메모리 다운사이클 저점' },
        { date: '2024-03', title: 'HBM 부상 + 폭등' },
      ],
    },

    '364980': {
      label: '364980 · TIGER 2차전지TOP10',
      badge: { cls: 'tiger', text: 'TIGER' },
      nameKo: 'TIGER 2차전지TOP10',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2020-10', 10000], ['2021-12', 23000], ['2022-09', 18000],
        ['2023-08', 26000], ['2024-01', 14000], ['2024-12', 10000],
        ['2025-06', 11000], ['2026-05', 12000],
      ],
      events: [
        { date: '2020-10', title: 'TIGER 2차전지TOP10 상장' },
        { date: '2021-12', title: '2차전지 슈퍼사이클 1차 정점' },
        { date: '2023-08', title: '단기 정점 — 이후 EV 둔화' },
        { date: '2024-12', title: 'EV 캐즘 + 인플레로 저점' },
      ],
    },

    '133690': {
      label: '133690 · TIGER 미국나스닥100',
      badge: { cls: 'tiger', text: 'TIGER' },
      nameKo: 'TIGER 미국나스닥100',
      region: 'kr',
      currency: '₩',
      refs: [
        ['2010-10', 6000], ['2014-01', 8000], ['2018-09', 19000],
        ['2020-03', 13000], ['2021-11', 38000], ['2022-12', 23000],
        ['2024-06', 65000], ['2024-12', 75000], ['2026-05', 95000],
      ],
      events: [
        { date: '2010-10', title: 'TIGER 미국나스닥100 상장' },
        { date: '2020-03', title: 'COVID 저점' },
        { date: '2021-11', title: '메가캡 정점' },
        { date: '2022-12', title: '기술주 조정 저점' },
        { date: '2024-06', title: 'AI 사이클 + 환율 시너지' },
      ],
    },
