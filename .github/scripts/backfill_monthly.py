...
| 종목 | 분위기 | 그 달 주요 이벤트 |
|---|---|---|
| 🍎 애플 (AAPL) | 🟢/🟡/🔴 또는 — | 헤드라인 있으면 1-2개 한 줄로 묶기. 없으면 `🤷 뚜렷한 기사 없음` |
| 🚗 테슬라 (TSLA) | ... | ... |
| 🤖 엔비디아 (NVDA) | ... | ... |
| 🏥 UNH 유나이티드헬스 | ... | ... |
| 🦅 PLTR 팔란티어 | ... | ... |
...
## 글쓰기 톤 (꼭 지킬 것 — 위반 시 리포트 무효)
독자는 **경제·분석 용어 익숙하지 않은 초보 투자자**. 한국어 친구한테 카톡으로 시장 얘기해주는 톤. "~했습니다" 보다 "~했어요" 또는 "~함" 쪽.

**나쁜 예 (피할 것)**
> 4월 미국 증시는 빅테크 기업들의 호실적에 힘입어 뚜렷한 상승세를 보였습니다. S&P 500 지수는 7,200선을 돌파하며 사상 최고치를 기록했으며, 나스닥 종합지수는 2020년 4월 이후 가장 좋은 월간 상승률을 기록했습니다.

**좋은 예 (이 톤으로)**
> 4월은 빅테크들이 실적 잘 내면서 미국 증시가 사상 최고치 찍었어요. 특히 나스닥은 한 달 상승률만 보면 코로나 직후인 2020년 4월 이후 제일 좋았던 달.

**규칙**
- 분석가 용어·영문 약어는 한국어로 풀어쓸 것:
  - ❌ "FOMC dissent" → ✅ "연준 회의에서 반대 의견"
  - ❌ "EPS $2.56, +21% YoY" → ✅ "실적이 작년보다 21% 늘었음"
  - ❌ "dovish / capex / P/E 부담" → ✅ "금리 완화 쪽 / 설비 투자 / 벌어들이는 돈 대비 비싼 편"
- 일반 시사 용어 (연준, 호르무즈 해협, FOMC, 코스피)는 풀어쓰지 말 것 — 잔소리.
- "~했습니다" 같은 격식체 ❌. "~했음" / "~했어요" / "~했네" 톤.
- 분기 매출·EPS·P/E·자본지출 같은 분석가 숫자 빼라. "X% 늘었다" 정도.
- 한 문장 짧게, 콘텍스트 하나당.
- "왜 중요한가" 는 *사용자에게 무엇이 바뀌는지* 관점 한 줄.
