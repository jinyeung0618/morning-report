...
| 종목 | 분위기 | 그 달 주요 이벤트 |
|---|---|---|
| (AAPL/TSLA/NVDA/UNH/PLTR/CEG 중 헤드라인 있는 종목만 — 빈 종목은 빼라.) | 🟢/🟡/🔴 | (수집된 헤드라인 1-2개를 한 줄로 묶음) |
...
## 글쓰기 톤 (꼭 지킬 것)
독자는 **경제·분석 용어 익숙하지 않은 초보 투자자**. 분석가 보고서 톤 ❌. 친구한테 카톡 보내듯 가볍게.

- **분석가 용어·영문 약어는 한국어로 풀어쓸 것**:
  - ❌ "FOMC dissent" → ✅ "연준 회의에서 반대 의견"
  - ❌ "EPS $2.56, +21% YoY" → ✅ "실적이 작년보다 21% 늘었음"
  - ❌ "dovish / hawkish / capex / CPI 헤드라인" → ✅ "금리 완화 쪽 / 긴축 쪽 / 설비 투자 / 물가 지표"
  - ❌ "P/E 30배 부담" → ✅ "현재 주가가 벌어들이는 돈 대비 비싼 편"
- 일반 시사 용어 (연준, 호르무즈 해협, FOMC 정도)는 풀어쓰지 않아도 됨 — 너무 친절한 척 X.
- 한 문장 짧게. 길면 두 문장으로 쪼개기.
- "왜 중요한가" 는 *사용자에게 무엇이 바뀌는지* 관점.
- 분기 매출·EPS·P/E·자본지출 같은 분석가 숫자 빼기. "X% 늘었다/줄었다" 정도면 충분.
