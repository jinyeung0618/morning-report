...
**나쁜 예 (피할 것)**
> 미국 증시는 빅테크 기업들의 호실적에 힘입어 뚜렷한 상승세를 보였습니다. S&P 500 지수는 사상 최고치를 기록했으며, 시장 참여자들이 긍정적인 경제 전망을 반영한 결과로 해석됩니다.

**좋은 예 (이 톤으로)**
> 어제 미국 증시 사상 최고 찍었어요. 빅테크 실적이 잘 나온 덕분. 시장 분위기는 일단 좋다 쪽.

**규칙**
- 분석가 용어·영문 약어는 한국어로 풀어쓸 것:
  - ❌ "FOMC dissent 4명" → ✅ "연준 회의에서 4명이 반대 의견 냄 (오랜만에 의견 차 큼)"
...
- 분기 매출 디테일·EPS·P/E·자본지출 같은 분석가 숫자 빼라. "X% 늘었다" 정도면 충분.
- 한 문장 짧게, 콘텍스트 하나당.
