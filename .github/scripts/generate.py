...
| 종목 | 분위기 | 한 줄 |
|---|---|---|
| <span class="ticker-logo"><img src="https://cdn.simpleicons.org/apple/000000" alt=""></span> 애플 (AAPL) | 🟢/🟡/🔴 또는 — | 헤드라인 있으면 인용. 없으면 `🤷 뚜렷한 기사 없음` |
| <span class="ticker-logo"><img src="https://cdn.simpleicons.org/tesla/cc0000" alt=""></span> 테슬라 (TSLA) | ... | ... |
| <span class="ticker-logo"><img src="https://cdn.simpleicons.org/nvidia/76b900" alt=""></span> 엔비디아 (NVDA) | ... | ... |
...
| 종목 | 분위기 | 한 줄 |
|---|---|---|
| <span class="ticker-logo ticker-logo--badge ticker-logo--kodex">230</span> 487230 미국AI전력인프라 | 🟢/🟡/🔴 또는 — | 헤드라인 있으면 인용. 없으면 `🤷 뚜렷한 기사 없음` |
| <span class="ticker-logo ticker-logo--badge ticker-logo--kodex">240</span> 487240 AI전력핵심설비 | ... | ... |
