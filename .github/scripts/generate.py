...
- **분석가 용어·영문 약어는 한국어로 풀어쓸 것**:
  - ❌ "FOMC dissent 4명" → ✅ "연준 회의에서 4명이 반대 의견 (오랜만에 의견 차이 큼)"
...
| 종목 | 분위기 | 한 줄 |
|---|---|---|
| (AAPL/TSLA/NVDA/UNH/PLTR/CEG 중 헤드라인 있는 종목만. 0개면 이 표 생략) | 🟢/🟡/🔴 | (헤드라인 인용 기반) |

### 🇰🇷 국내

| 종목 | 분위기 | 한 줄 |
|---|---|---|
| (487230/487240 중 헤드라인 있는 종목만. 0개면 이 표 생략) | 🟢/🟡/🔴 | (헤드라인 인용 기반) |
